...
> Dice-Game-With-Tailwind is a project that is similar to what we have created earlier, but this time with different tools like Tailwind CSS, Prettier, and ESLint, built with Webpack. Please check out the live demo to experience the project.
...
- LinkedIn: [Aggrey Wanjala](https://www.linkedin.com/in/aggrey-wanjala-185bb2255/)
